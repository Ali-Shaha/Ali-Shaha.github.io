...
- **CFD** for complex flows  
- **Compressible** and **multiphase flow** modeling  
- **Chemical reaction modeling** and **Electrochemistry**  
- **CFD-driven model development**

I am interested in applying numerical models and simulation to solve real-world engineering problems and advance energy technologies. Outside of work, I enjoy exploring new CFD methods and modeling techniques.
